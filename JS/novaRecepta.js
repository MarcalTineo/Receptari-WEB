...
function submit() {
	...
	form.addEventListener("submit", () => {
		...
		//saltar la num 0 perque és la template i no te dades.
		for (let i = 1; i < ingredientTableRows.length; i++) {
			const element = ingredientTableRows[i];
			let ingredient = [];
			//llegeix valors de la taula.
			ingredient[0] = ingredientTableRows.children[1].children[0].value;
			ingredient[1] = ingredientTableRows.children[2].children[0].value;
			ingredient[3] = ingredientTableRows.children[4].children[0].value;
